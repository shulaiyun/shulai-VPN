...
final _logger = Loggy('FFISlothVPNCoreService');

class CoreInterfaceMobile extends CoreInterface with InfraLogger {
  static const channelPrefix = "top.shulaiyun.slothvpn";
  ...
  Future<String> setup(Directories directories, bool debug, int mode) async {
    ...
    // await start("/sdcard/Android/data/top.shulaiyun.slothvpn/files/configs/cdc633e9-8cfc-4a67-948d-009f779a5c91.json", "hiddify");
    return "";
  }
  ...
  Future<CoreStatus> setupBackground(String path, String name) async {
    ...
    // gRPC server can accept TCP before unary handlers are fully ready.
    // A short delay avoids immediate "unavailable" races in start().
