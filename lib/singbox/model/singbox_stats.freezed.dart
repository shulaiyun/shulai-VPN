...
mixin _$SingboxStats {
  ...
  $SingboxStatsCopyWith<SingboxStats> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SingboxStatsCopyWith<$Res> {
  factory $SingboxStatsCopyWith(SingboxStats value, $Res Function(SingboxStats) then) =
      _$SingboxStatsCopyWithImpl<$Res, SingboxStats>;
  @useResult
  $Res call({int connectionsIn, int connectionsOut, int uplink, int downlink, int uplinkTotal, int downlinkTotal});
}

/// @nodoc
class _$SingboxStatsCopyWithImpl<$Res, $Val extends SingboxStats> implements $SingboxStatsCopyWith<$Res> {
...
/// @nodoc
abstract class _$$SingboxStatsImplCopyWith<$Res> implements $SingboxStatsCopyWith<$Res> {
  factory _$$SingboxStatsImplCopyWith(_$SingboxStatsImpl value, $Res Function(_$SingboxStatsImpl) then) =
...
/// @nodoc
class __$$SingboxStatsImplCopyWithImpl<$Res> extends _$SingboxStatsCopyWithImpl<$Res, _$SingboxStatsImpl>
    implements _$$SingboxStatsImplCopyWith<$Res> {
  __$$SingboxStatsImplCopyWithImpl(_$SingboxStatsImpl _value, $Res Function(_$SingboxStatsImpl) _then)
    : super(_value, _then);
...
class _$SingboxStatsImpl extends _SingboxStats {
  ...
  factory _$SingboxStatsImpl.fromJson(Map<String, dynamic> json) => _$$SingboxStatsImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.connectionsIn, connectionsIn) || other.connectionsIn == connectionsIn) &&
            (identical(other.connectionsOut, connectionsOut) || other.connectionsOut == connectionsOut) &&
            (identical(other.uplink, uplink) || other.uplink == uplink) &&
            (identical(other.downlink, downlink) || other.downlink == downlink) &&
            (identical(other.uplinkTotal, uplinkTotal) || other.uplinkTotal == uplinkTotal) &&
            (identical(other.downlinkTotal, downlinkTotal) || other.downlinkTotal == downlinkTotal));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, connectionsIn, connectionsOut, uplink, downlink, uplinkTotal, downlinkTotal);
...
abstract class _SingboxStats extends SingboxStats {
  ...
  factory _SingboxStats.fromJson(Map<String, dynamic> json) = _$SingboxStatsImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$SingboxStatsImplCopyWith<_$SingboxStatsImpl> get copyWith => throw _privateConstructorUsedError;
}
