...
_$SingboxStatsImpl _$$SingboxStatsImplFromJson(Map<String, dynamic> json) => _$SingboxStatsImpl(
...
Map<String, dynamic> _$$SingboxStatsImplToJson(_$SingboxStatsImpl instance) => <String, dynamic>{
