...
class IntroPage extends HookConsumerWidget with PresLogger {
  ...
  Future<void> autoSelectRegion(WidgetRef ref) async {
    // Keep first-run region default on "other" to avoid region-specific routing issues.
    final currentRegion = ref.read(ConfigOptions.region);
    try {
