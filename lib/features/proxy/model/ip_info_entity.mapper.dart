...
class IpInfoMapper extends ClassMapperBase<IpInfo> {
  ...
  static const Field<IpInfo, String> _f$countryCode = Field('countryCode', _$countryCode);
  static String? _$region(IpInfo v) => v.region;
  static const Field<IpInfo, String> _f$region = Field('region', _$region, opt: true);
  ...
  static const Field<IpInfo, String> _f$timezone = Field('timezone', _$timezone, opt: true);
...
mixin IpInfoMappable {
  ...
  IpInfoCopyWith<IpInfo, IpInfo, IpInfo> get copyWith => _IpInfoCopyWithImpl(this as IpInfo, $identity, $identity);
  @override
  String toString() {
...
extension IpInfoValueCopy<$R, $Out> on ObjectCopyWith<$R, IpInfo, $Out> {
  IpInfoCopyWith<$R, IpInfo, $Out> get $asIpInfo => $base.as((v, t, t2) => _IpInfoCopyWithImpl(v, t, t2));
}

abstract class IpInfoCopyWith<$R, $In extends IpInfo, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? ip, String? countryCode, String? region, String? city, String? timezone, String? asn, String? org});
...
class _IpInfoCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, IpInfo, $Out>
  ...
  @override
  IpInfoCopyWith<$R2, IpInfo, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) => _IpInfoCopyWithImpl($value, $cast, t);
}
